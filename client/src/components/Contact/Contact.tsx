  ...
  return (
    <div className='Contact-container'>
      ...
      <div className='Contact-content'>
        ...
        <p>Or send me an email at <a href="mailto:someone@yoursite.com">karen.planaspena@gmail.com</a></p>
        <p>When I'm not coding you might find me biking or reading on my hammock, by the Saint Laurence river.
        </p>
